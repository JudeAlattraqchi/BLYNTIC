        ...
        <div className="max-w-4xl mx-auto text-center mb-16">
          ...
          <Reveal delay={0.2}>
            <p className="text-xl text-gray-600 mb-10 max-w-2xl mx-auto leading-relaxed">
              Ready to transform your business with AI? Sign up before May 15th and we'll waive our standard implementation and setup fees. That's a savings of up to $15,000.
            </p>
          </Reveal>
        </div>
